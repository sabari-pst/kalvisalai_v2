...
const EditGrade = (props) => {
    ...
    const handleFormSubmit=(e)=>{
        ...
        setLoader(true);
        axios.post(ServiceUrl.HR.UPDATE_GRADE, $("#frm_UpdateHrGrade").serialize()).then(res=>{
        ...
        <>
            <Spin spinning={loader} >
                ...
                >
                    ...
                    <Row className="mt-1">
                        <Col md={12}>
                            <label>Grade Name <span className="text-danger">*</span></label>
                            <Form.Control
                                type="text"
                                name="grade_name"
                                defaultValue={field("grade_name")}
                                size="sm"
