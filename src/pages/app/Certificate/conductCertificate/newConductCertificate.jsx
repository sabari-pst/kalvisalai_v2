...
const NewConductCertificate = (props) => {
  ...
  const loadTemplate = () => {
    setLoader(true);
    getStudentTemplate(CERTIFICATE_TEMPLATE_NAMES.STUDENT_CONDUCT).then(
      (res) => {
  ...
  const getContent = () => {
    ...
    ar["{{year}}"] = yearBySem(studentField("semester"), true);
  ...
  const handleSaveClick = () => {
    ...
    axios
      .post(ServiceUrl.STUDENTS.SAVE_CONDUCT_CERTIFICATE, form)
      .then((res) => {
        if (res["data"].status == "1") {
          toast.success(res["data"].message || "Success");
          printDocument("print_stu_conduct");
            ...
            <>
              ...
              <div className="mt-3 text-center">
                ...
                {props.dataSource && props.dataSource.uuid && (
                  <Button
                    size=""
                    onClick={(e) => printDocument("print_stu_conduct")}
                  >
...
export default NewConductCertificate;
