...
import { listDepartments } from '../../../../models/hr';
...
const DepartmentMaster = (props) => {
    ...
    const handleDeleteClick = (item) => {
        ...
        axios.post(ServiceUrl.HR.REMOVE_DEPARTMENT, form).then(res => {
    ...
    const handleSearch = (e) => {
        let m = dataList.filter(item => (upperCase(item.department_name).indexOf(upperCase(e.target.value)) > -1));
    ...
    return (
        <>
            ...
            <CardFixedTop title="Department Master" >
                <ul className="list-inline mb-0">
                    <ModuleAccess module="hr_department" action="action_create">
