...
const AddGallery = (props) => {
  ...
  const handleFormSubmit = (e) => {
    ...
    setLoader(true);
    axios
      .post(ServiceUrl.WEBSITE_CMS.SAVE_GALLERY, new FormData(form))
      .then((res) => {
        if (res["data"].status == "1") {
          toast.success(res["data"].message || "Success");
          document.getElementById("frm_add_gallery").reset();
          setSelectedFiles([]);
              ...
              <Col md={12}>
                <div className="text-end">
                  <Button type="submit" className="" ref={buttonRef}>
                    <i className="fa-solid fa-check me-2 fs-6"></i>Save Gallery
                  </Button>
                </div>
              </Col>
            </Row>
