...
const DeptVisionMission = (props) => {
  ...
  const handleFormSubmit = (e) => {
    ...
    if (!context.allowedAccess("dept_cms_vision_mission", "action_update"))
      return;
  ...
  return (
    <DepartmentCmsLayout>
      <CardFixedTop title="Vision & Mission">
                ...
                <div className="text-end">
                  ...
                  >
                    <LoaderSubmitButton
                      ...
                      text={
                        <>
                          <i className="fa-solid fa-check me-2"></i> Save Vison
                          & Mission
                        </>
                      }
                    />
...
export default withRouter(DeptVisionMission);
