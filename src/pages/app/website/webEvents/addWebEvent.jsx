    ...
    axios
      ...
      .then((res) => {
        if (res["data"].status == "1") {
          ...
          document.getElementById("frm_add_Event").reset();
          setTitle("");
          setEditSlug("");
          setEditorContent("");
      ...
      <CardFixedTop title="Add Event">
        <ul className="list-inline mb-0">
          ...
          <li className="list-inline-item">
            ...
            >
              <i className="fa-solid fa-check fs-5 px-1"></i>Save Event
            </Button>
          </li>
        </ul>
      </CardFixedTop>
...
export default withRouter(AddWebEvent);
