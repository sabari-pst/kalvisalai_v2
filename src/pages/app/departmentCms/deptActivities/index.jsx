...
const DeptActivities = (props) => {
  ...
  const handleFormSubmit = (e) => {
    ...
    if (!context.allowedAccess("dept_cms_activities", "action_update")) return;
...
export default withRouter(DeptActivities);
