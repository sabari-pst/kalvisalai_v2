...
const AddTemplate = (props) => {
    ...
    const handleFormSubmit = (e) => {
        ...
        setLoader(true);
        axios.post(ServiceUrl.ADMISSION.ADD_MAIL_TEMPLATES, $("#frm_AddTemplate").serialize()).then(res => {
    ...
    return (
        <>
            <Spin spinning={loader}>
                <Form noValidate validated={validated} method="post" id="frm_AddTemplate" onSubmit={handleFormSubmit}>
                    <Row>
                        <Col md={12} >
