...
const NewUserRole = (props) => {
	...
	const handleFormSubmit = (e) => {
		...
		setLoader(true);
		axios.post(ServiceUrl.SETTINGS.SAVE_USERROLE, $("#frm_SaveUserRole").serialize()).then(res => {
			if(res['data'].status=='1'){
				toast.success(res['data'].message || 'Success');
				document.getElementById("frm_SaveUserRole").reset();
		...
		<>
			<PsModalWindow {...props} >
				...
				>
					<Row>
						<Col md={12}>
							<label>Name of the Role <span className="text-danger">*</span></label>
							<Form.Control
								type="text"
								size="sm"
								className="fw-bold"
