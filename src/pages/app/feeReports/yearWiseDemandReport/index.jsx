...
const YearWiseDemandReport = (props) => {
  ...
  const getTitle = () => {
    if (selectedCourse && selectedCourse.fee_group_name)
      return `Year Wise Demand Report > ${selectedCourse.fee_group_name}`;
    return "Year Wise Demand Report";
  };
...
export default YearWiseDemandReport;
