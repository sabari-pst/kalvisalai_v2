...
const EditWebPage = (props) => {
    ...
    const [originalText, setOriginalText] = useState((props.dataSource.content));
    ...
    const handleFormSubmit = (e) => {
        ...
        setLoader(true);
        axios.post(ServiceUrl.ADMISSION.UPDATE_PAGE, $("#frm_UpdatePage").serialize()).then(res => {
                                    ...
                                    <div className="editor-wrapper">
                                        <Editor
                                            init={{
                                                ...
                                                toolbar:
                                                    "bold italic forecolor link image | alignleft aligncenter alignright | hr bullist numlist table | subscript superscript | removeformat code",
                                            ...
                                            initialValue={props.dataSource.content}
