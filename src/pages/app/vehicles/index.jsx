...
const Vehicles = (props) => {
   ...
   return (
       ...
       <CardFixedTop title="Vehicles" >
            <ul className="list-inline mb-0">
                <li className='list-inline-item' >
                    <ModuleAccess module={'transport_fee_vehicles'} action={'action_create'}>
                                ...
                                <tbody>
                                    {dataView.map((item, i)=>{
                                        return <tr key={i} className={item.active_status=='0' ? 'text-danger' : ''} >
                                            ...
                                            <td align="center" >
                                                <ModuleAccess module={'transport_fee_vehicles'} action={'action_update'}>
                                                    <Button size="sm" variant="transparent" title="Edit Group" onClick={e => handleEdit(item)}>
                                                        <i className='fa-solid fa-pen fs-6'></i>
                                                    </Button>
                                                </ModuleAccess>
                                                <ModuleAccess module={'transport_fee_vehicles'} action={'action_delete'}>
