...
import NewVerificationCertificate from "./newVerificationCertificate";

const VerificationCertificate = (props) => {
  ...
  const getReport = () => {
    ...
    axios
      .get(
        ServiceUrl.STUDENTS.LIST_MEDIUM_CERTIFICATES +
          "?&" +
  ...
  const handleDeleteClick = (item) => {
    ...
    axios
      .post(ServiceUrl.STUDENTS.DELETE_MEDIUM_CERTIFICATE, form)
      .then((res) => {
        if (res["data"].status == "1") {
  ...
  const columns = [
    ...
    { title: "Medium of Study", dataIndex: "medium_of_instruction" },
    {
      title: "Batch",
      dataIndex: "batch",
      width: 120,
  ...
  return (
    <>
      <CardFixedTop title="Medium Certificates">
      ...
      <PsOffCanvasWindow
        show={showAdd}
        title="New Verification Certificate"
        onHide={(e) => {
          setShowAdd(false);
          setEditData([]);
        }}
...
export default withRouter(VerificationCertificate);
