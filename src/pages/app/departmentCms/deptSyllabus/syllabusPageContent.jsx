...
const DeptSyllabus = (props) => {
  ...
  const handleFormSubmit = (e) => {
    ...
    if (!context.allowedAccess("dept_cms_syllabus", "action_update")) return;
              ...
              <div className="text-end">
                <ModuleAccess module="dept_cms_syllabus" action="action_update">
                  <LoaderSubmitButton
                    ...
                    text={
                      <>
                        <i className="fa-solid fa-check me-2"></i> Save Content
                      </>
                    }
                  />
                </ModuleAccess>
          ...
          <Row className="mt-3">
            <Col md={12}>
              <label>
                ...
                >
                  <i className="fa-regular fa-folder-open me-2"></i> Open File
                  Manager
                </Button>
              </label>
            </Col>
            <Col md={12} className="mt-3">
              ...
              />
              <input type="hidden" name="page_content" value={editorContent} />
            </Col>
          </Row>
        </Form>
      </Spin>
