    ...
    axios
      ...
      .then((res) => {
        if (res["data"].status == "1") {
          ...
          document.getElementById("frm_add_Page").reset();
          setTitle("");
          setEditSlug("");
          setEditorContent("");
        } else {
      ...
      <CardFixedTop title="Add Page">
        <ul className="list-inline mb-0">
          ...
          <li className="list-inline-item">
            ...
            >
              <i className="fa-solid fa-check fs-5 px-1"></i>Save Page
            </Button>
          </li>
        </ul>
      </CardFixedTop>
...
export default withRouter(AddWebPage);
