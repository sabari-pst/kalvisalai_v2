    ...
    <>
      <Card className="bg-blue-100 border-0">
        <Card.Body style={{ minHeight: "200px" }}>
          ...
          >
            <i className="fa-sharp fa-solid fa-arrow-left fs-4"></i>
          </Button>
          ...
          <img
            src={MOB_ICONS.PASSWORD_256.default}
      ...
      <div className="px-3 mt-5">
        ...
        >
          ...
          <input type="hidden" name="staff_uuid" value={props.staffUuid} />
          <Row className="mt-3">
            <Col md={12}>
              <Form.Control
                type="number"
