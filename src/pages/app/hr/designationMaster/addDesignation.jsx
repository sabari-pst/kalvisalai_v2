...
const AddDesignation = (props) => {
    ...
    const handleFormSubmit = (e) => {
        ...
        setLoader(true);
        axios.post(ServiceUrl.HR.SAVE_DESIGNATION, $("#frm_saveDesignation").serialize()).then(res => {
            if (res['data'].status == '1') {
                document.getElementById("frm_saveDesignation").reset();
                if (props.onSuccess)
                    props.onSuccess();
