...
const DeptAbout = (props) => {
  ...
  const handleFormSubmit = (e) => {
    ...
    if (!context.allowedAccess("dept_cms_about", "action_update")) return;
          ...
          <Form onSubmit={handleFormSubmit}>
            ...
            <Row className="mt-2">
              ...
              <Col md={3} className="mt-4">
                <input type="hidden" name="show_in_page" value="1" />
              </Col>
              <Col md={3} className="mt-4">
                <div className="text-end">
                  <ModuleAccess module="dept_cms_about" action="action_update">
                    <LoaderSubmitButton
                      type="submit"
                      loading={loader}
                      text={
...
export default withRouter(DeptAbout);
