...
const ClassWiseDemandReport = (props) => {
  ...
  }, [JSON.stringify(context.cashbook), selectedCourse]);
  ...
  const getTitle = () => {
    if (selectedCourse && selectedCourse.fee_group_name)
      return `Class Wise Demand Report > ${selectedCourse.fee_group_name}`;
    return "Class Wise Demand Report";
  };
                      ...
                      >
                        <table>
                          ...
                          <tfoot className="fw-bold">
                            <tr>
                              <td className="" colSpan={5} align="right">
                                Total :{" "}
                              </td>
                              <td className="" align="right">
                                <b>{getOverallTotal()}</b>
...
export default ClassWiseDemandReport;
