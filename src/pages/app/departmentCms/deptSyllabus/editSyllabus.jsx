...
const EditSyllabus = (props) => {
  ...
  useEffect(() => {
    loadAcademics();
    setSelectedFiles(field("file_path"));
  }, []);
  ...
  const handleFormSubmit = (e) => {
    ...
    setLoader(true);
    axios
      .post(ServiceUrl.DEPT_CMS.UPDATE_FILE, new FormData(form))
      .then((res) => {
    ...
    <div>
      <PsModalWindow {...props}>
        <Spin spinning={loader}>
          ...
          >
            <input type="hidden" name="row_type" value={field("row_type")} />
                ...
                >
                  ...
                  {courseTypes.map((item) => (
                    <option
                      value={item[0].type}
                      selected={
                        field("course_type") == item[0].type ? "selected" : ""
                      }
                    >
              ...
              <Col md={6}>
                ...
                >
                  ...
                  {academicYear.map((item) => (
                    <option
                      value={item.batch}
                      selected={field("batch") == item.batch ? "selected" : ""}
                    >
...
export default withRouter(EditSyllabus);
