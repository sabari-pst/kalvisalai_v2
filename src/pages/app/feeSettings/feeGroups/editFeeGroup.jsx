...
const EditFeeGroup = (props) => {
	...
	const handleFormSubmit = (e) => {
		...
		setLoader(true);
		axios.post(ServiceUrl.FEE_CATEGORY.UPDATE_FEE_GROUP, $("#frm_updateFeeGroup").serialize()).then(res => {
					...
					<Row>
						<Col md={12}>
							...
							<Form.Control
								...
								className="fw-bold"
								name="fee_group_name"
								defaultValue={field('fee_group_name')}
								required
							/>
						</Col>
					</Row>
