...
const WebGallery = (props) => {
  ...
  const loadData = () => {
    ...
    axios
      .post(
        ServiceUrl.WEBSITE_CMS.LIST_GALLERIES +
          "?type=gallery&" +
  ...
  const deletePage = (item) => {
    ...
    form.append("gallery_id", item.category);
    axios.post(ServiceUrl.WEBSITE_CMS.DELETE_GALLERY, form).then((res) => {
      if (res["data"].status == "1") {
  ...
  const columns = [
    ...
    },
    {
      ...
      align: "center",
      render: (text, record) =>
        record.category_order != "0" && record.category_order,
    },
    {
      title: "Manage",
      dataIndex: "id",
      ...
      render: (text, record, index) => (
        <>
          <ModuleAccess module="cms_web_gallery" action="action_update">
            <Button
              size="sm"
              variant="transparent"
              title="Remove"
          ...
          <ModuleAccess module="cms_web_gallery" action="action_delete">
            <Button
              size="sm"
              variant="transparent"
              title="Remove"
  ...
  return (
    <>
      <CardFixedTop title="Gallery">
        <ul className="list-inline mb-0">
          <ModuleAccess module="cms_web_gallery" action="action_create">
            <li className="list-inline-item">
              ...
              >
                <i className="fa-solid fa-plus fs-5 px-1"></i>New Gallery
              </Button>
            </li>
          </ModuleAccess>
          <li className="list-inline-item">
...
export default withRouter(WebGallery);
